...
class Minesweeper extends JFrame implements ActionListener, ContainerListener {
    ...
    public void loadImageIcons() {
        ...
        for (int i = 1; i < 8; i++) {
            name = "images/" + i + ".gif";
            ic[i] = getImageIcon(name);
        }
        ic[9] = getImageIcon("images/mine.gif");
        ic[10] = getImageIcon("images/flag.gif");
        ic[11] = getImageIcon("images/new game.gif");
        ic[12] = getImageIcon("images/crape.gif");
    }
